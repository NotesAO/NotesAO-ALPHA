        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM curriculum";
                    ...
                    $sql = "SELECT * FROM curriculum ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM curriculum
                            WHERE CONCAT_WS (id,short_description,long_description)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
										...
										echo "<th><a href=?search=$search&sort=&order=short_description&sort=$sort>short_description</th>";
										echo "<th><a href=?search=$search&sort=&order=long_description&sort=$sort>long_description</th>";
