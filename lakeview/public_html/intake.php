<?php
/**
 * lakeview – BIPP Virtual Intake Packet
 * ------------------------------------
 * • GET  : render multi‑step form  (HTML follows this PHP section)
 * • POST : CSRF check → validate → INSERT into clinicnotepro_lakeview.intake_packet
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    @mail(
        ...
        $headers,
        '-freporting@lakeview.notesao.com'            // ← some MTAs (esp. cPanel) require this
    );
...
<form method="post">
  ...
  <fieldset class="step" id="step-client-consents">
    ...
    <!-- Section: Lakeview Education Program Agreement -->
    <div class="mb-4">
