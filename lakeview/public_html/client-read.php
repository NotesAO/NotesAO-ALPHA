...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Client Record</title>
                    ...
                    <div class="page-header">
                     ...
                     <div class="form-group">
                           ...
                           <h4>Emergency Contact</h4>
                            ...
                            <h4>behavior contract status</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["behavior_contract_status"]); ?></p>
                        </div><div class="form-group">
                            <h4>behavior contract signed date</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["behavior_contract_signed_date"]); ?></p>
                        </div>
