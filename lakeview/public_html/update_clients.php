...
include_once '/home/notesao/lakeview/config/config.php'; // Adjust path if needed
 ...
 *
 * @param string $clinic_folder e.g. 'lakeview'
...
$clinic_folder   = 'lakeview'; // Adjust or derive dynamically if needed
...
if (!empty($csvMirrorUpdates)) {
    // $clinic_folder is already set above to 'lakeview' (or derived dynamically)
