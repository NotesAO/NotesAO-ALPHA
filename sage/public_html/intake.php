<?php
/**
 * Sage – BIPP Virtual Intake Packet
 * ------------------------------------
 * • GET  : render multi‑step form  (HTML follows this PHP section)
 * • POST : CSRF check → validate → INSERT into clinicnotepro_sage.intake_packet
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $headers  = "From: reporting@sage.notesao.com\r\n";
    $headers .= "Reply-To: " . postv('email') . "\r\n";   // nice but optional
    $headers .= "X-Mailer: PHP/" . PHP_VERSION;

    @mail(
        ADMIN_ALERT_EMAIL,
        "Sage has received a new Intake Packet for $fname $lname",
        "A new online intake packet was submitted.\n\nView pending & submitted packets:\nhttps://{$_SERVER['HTTP_HOST']}/intake-index.php",
        $headers,
        '-freporting@sage.notesao.com'            // ← some MTAs (esp. cPanel) require this
    );
...
if (!empty($_SESSION['show_thank_you_once'])) {
    ...
    <div class="jumbotron bg-white text-center shadow-sm py-4 mb-4">
      <a href="https://sagesubstanceabuseguidanceandeducationllc.org" target="_blank" rel="noopener">
        <img src="sagelogo.png" alt="Sage Logo"
    ...
    <div class="card shadow-sm">
      <div class="card-body text-center p-5">
        ...
        <a href="https://sagesubstanceabuseguidanceandeducationllc.org" class="btn btn-primary btn-lg">
          Sage Home
        </a>
      </div>
    </div>
...
<!-- Jumbotron / Header Section -->
    <div class="jumbotron bg-white text-center shadow-sm py-4">
      <a href="https://sagesubstanceabuseguidanceandeducationllc.org" target="_blank">
        <!-- Responsive Image -->
          <img 
              src="sagelogo.png" 
              alt="Sage Logo" 
...
<form method="post">
  ...
  <fieldset class="step">
    ...
    outside Sage – BIPP. This right applies with the following exceptions:</p>
    ...
    <ul>
        ...
        <li><strong>Media involvement:</strong> Any media contact arranged by the Sage program
            will include the presence of a Sage employee to protect victim confidentiality.</li>
    </ul>

    <p><strong>We ask that you keep confidential information you may learn about other clients who are
    receiving services from Sage – BIPP.</strong></p>

    <p><strong>Sage requires facilitators and participants to:</strong></p>
    <ul>
    ...
    I accept these terms as a condition of participation in the Sage – Batterers Intervention &amp;
  ...
  <fieldset class="step" id="step-client-consents">
    ...
    <div class="mb-4">
      ...
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        ...
        <p>I understand that I may revoke this consent at any time and that my request for revocation must be in writing. If not earlier revoked, this consent for disclosure of information shall expire 1 year after my completion of or termination from Sage - Batterers Intervention & Prevention Program.</p>
        <p>I understand my right to confidentiality. I further understand that this consent form gives Sage - BIPP permission to share confidential information about me in the way described above.</p>
        <p>I understand that Victim will be contacted by the Victim Advocate and offered counseling services. She/He will be provided enrollment, completion, or termination information from Sage - BIPP.</p>
        <p>Release of information is voluntary; I understand I have a right to refuse Sage - BIPP's request for this disclosure.</p>
        <p>Sage - BIPP reserves the right to dismiss any client who refuses to meet the provisions of The Texas Department of Criminal Justice-Community Justice Assistance Division and Texas Council on Family Violence Battering Intervention & Prevention Project guidelines.</p>
      ...
      <div class="form-check">
        ...
        <label class="form-check-label" for="agree_disclosure">
          By checking "I Agree", I confirm that I have read, understood, and agree to abide by the terms and conditions outlined above. I acknowledge my rights and responsibilities as described, and I accept these terms as a condition of participation in the Sage - Batterers Intervention & Prevention Program.
        </label>
      </div>
    </div>

    <!-- Section: Sage Program Agreement -->
    <div class="mb-4">
      <label class="form-label fw-bold">Sage Program Agreement</label>
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        ...
        <p>You must be focused and facing your webcam during the entire group; <strong>NO</strong> watching TV or working on your computer. You will only be given one warning. Second warning will result in no credit for the session and/or a discharge violation from Sage BIPP program.</p>
        <p>You must be in a quiet room; not driving, in your car, or doing any other activity. Otherwise, you will receive no credit for that BIPP session and/or receive a discharge violation from Sage BIPP Program.</p>
        <p>If there is any interruption during your Sage by a child or adult, you will lose credit for your class and/or receive a discharge violation from Sage Program.</p>
        <p>If there is any appearance of alcohol or vaping during Sage, it will result in a request for a drug test. If found dirty, you must sign a behavioral contract or be unsuccessfully discharged from Sage BIPP Program.</p>
        <p>During your Sage, if there is any woman present even for a moment, especially the victim, you shall receive no credit for the class and/or be unsuccessfully discharged from Sage BIPP Program.</p>
        <p>If after a restroom break you do not return, or you take more than 5 minutes, you shall receive no credit for your Sage BIPP Group session.</p>
        ...
        <p>I will notify Sage BIPP of any change of address or phone number.</p>
        <p>I hereby agree to contact BIPP by phone at [contact number] when I am unable to attend a scheduled session. Failure to contact Sage within 2 consecutive absences is an automatic discharge from Sage Program.</p>
        ...
        <p>I understand that Sage BIPP is committed to helping me gain a better understanding of my problems and how to find productive solutions and that it is the main goal of my psychoeducational classes.</p>
      </div>
      <div class="form-check">
    ...
    <div class="mb-4">
      ...
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        ...
        <p>Sage requires me to disable any devices that could collect information from the environment, such as Google Home Assistant, Amazon Alexa, or Apple Siri, and I agree that I will not record nor take screenshots of the group. Sage requires me to be in a private space and not in any public area such as a park, yard, or open area; other people not in the group should not be exposed to the content nor hear or observe the group.</p>
    ...
    <div class="mb-4">
      ...
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        <p>I have received a copy of the "Policy for Clients" for Sage - BIPP. I understand my rights and responsibilities, and I agree to enter Sage - BIPP.</p>
        <p>I understand that in accordance with Guideline 31 of the Texas Department of Criminal Justice-Community Justice Assistance Division and Texas Council on Family Violence Battering Intervention Prevention Program guidelines, I am being provided a written agreement that clearly delineates the obligation of the Sage - BIPP to the client. I understand that the Sage - BIPP shall:</p>
        <ul>
        ...
        <ul>
          ...
          <li>Sage - BIPP client violates any of the BIPP rules.</li>
        </ul>
        ...
        <p>Clients have the right to seek other resources outside of Sage - BIPP, and when possible, Sage - BIPP staff will provide or make a referral.</p>
        ...
        <p>Sage - BIPP will provide batterers at the time of assessment (intake) with a copy of the circumstances under which they can be terminated before completion.</p>
        <p>I have read and understand the above statements and voluntarily enter into counseling services from the staff of Sage - BIPP - by entering my name below. (By clicking SUBMIT, I hereby confirm the above information to the best of my knowledge is correct and true, with no misleading or false content in accordance with Texas Perjury Statute, Sec. 37.02 (a) (2) Chapter 32, Civil Practice and Remedies Code.)</p>
      </div>
      <div class="form-check">
