<?php
include '/home/notesao/sage/public_html/auth.php';
...
// e.g. /home/notesao/NotePro-Report-Generator/templates/sage
    ...
    $cmd = escapeshellcmd("$python_interpreter $script")
         ...
         if ($report_type === "Progress Reports (Curriculum)") {
            ...
            $cmd .= ' --db_host ' . escapeshellarg('50.28.37.79')
                  . ' --db_user ' . escapeshellarg('clinicnotepro_sage_app')
                  . ' --db_pass ' . escapeshellarg('PF-m[T-+pF%g')
                  . ' --db_name ' . escapeshellarg('clinicnotepro_sage');
        }
