...
define('db_name', 'clinicnotepro_sage');
define('db_user', 'clinicnotepro_sage_app');
...
<div class="container">
    <a href="https://sagesubstanceabuseguidanceandeducationllc.org">
        <img alt="Sage Logo" src="sagelogo.png" class="img-fluid mb-3">
    </a>
    ...
    <div class="modal-content p-3">
      ...
      <?php if ($clientProgramId === 2 || $clientProgramId === 3): ?>
        <p>
          ...
          <a href="https://sage.notesao.com/intake.php/" target="_blank">
            Click Here
          </a>
        </p>
      <?php endif; ?>
