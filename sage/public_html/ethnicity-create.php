...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO ethnicity (id,code,name) VALUES (?,?,?)");

        if($stmt->execute([ $id,$code,$name  ])) {
                $stmt = null;
                header("location: ethnicity-index.php");
            } else{
...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Ethnicity Create</title>
