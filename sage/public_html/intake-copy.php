  ...
  <fieldset class="step" id="step-client-consents">
    ...
    <div class="mb-4">
      ...
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        ...
        <p>I hereby agree to contact BIPP by phone at [contact name] when I am unable to attend a scheduled session. Failure to contact Sage within 2 consecutive absences is an automatic discharge from Sage Program.</p>
