...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Absence Record</title>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <h4>excused</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["excused"]); ?></p>
                        </div><div class="form-group">
                            <h4>note</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["note"]); ?></p>
                        </div>

                    <p><a href="absence-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
