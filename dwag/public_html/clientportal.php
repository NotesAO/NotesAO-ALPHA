...
define('db_name', 'clinicnotepro_dwag');
define('db_user', 'clinicnotepro_dwag_app');
...
/* ----------  MONDAY MEN’S BIPP (therapy_group.id = 1) ---------- */
    // fee tiers: 35, 25, 15, 10, 0
    ['program_id'=>2,'therapy_group_id'=>1,'fee'=>35,'label'=>"Monday Men's BIPP",'day_time'=>"Monday",'link'=>'https://dwagbipp.org/dwagbippmondaymen35/'],
    ['program_id'=>2,'therapy_group_id'=>1,'fee'=>25,'label'=>"Monday Men's BIPP",'day_time'=>"Monday",'link'=>'https://dwagbipp.org/dwagbippmondaymen25/'],
    ['program_id'=>2,'therapy_group_id'=>1,'fee'=>15,'label'=>"Monday Men's BIPP",'day_time'=>"Monday",'link'=>'https://dwagbipp.org/dwagbippmondaymen15/'],
    ['program_id'=>2,'therapy_group_id'=>1,'fee'=>10,'label'=>"Monday Men's BIPP",'day_time'=>"Monday",'link'=>'https://dwagbipp.org/dwagbippmondaymen10/'],
    ['program_id'=>2,'therapy_group_id'=>1,'fee'=>0 ,'label'=>"Monday Men's BIPP",'day_time'=>"Monday",'link'=>'https://dwagbipp.org/dwagbippmondaymennofee/'],

/* ----------  WEDNESDAY MRT (therapy_group.id = 4) -------------- */
    ['program_id'=>1,'therapy_group_id'=>4,'fee'=>35,'label'=>"Wednesday MRT",'day_time'=>"Wednesday",'link'=>'https://dwagbipp.org/dwagmrtwednesday35/'],
    ['program_id'=>1,'therapy_group_id'=>4,'fee'=>25,'label'=>"Wednesday MRT",'day_time'=>"Wednesday",'link'=>'https://dwagbipp.org/dwagmrtwednesday25/'],
    ['program_id'=>1,'therapy_group_id'=>4,'fee'=>15,'label'=>"Wednesday MRT",'day_time'=>"Wednesday",'link'=>'https://dwagbipp.org/dwagmrtwednesday15/'],
    ['program_id'=>1,'therapy_group_id'=>4,'fee'=>10,'label'=>"Wednesday MRT",'day_time'=>"Wednesday",'link'=>'https://dwagbipp.org/dwagmrtwednesday10/'],
    ['program_id'=>1,'therapy_group_id'=>4,'fee'=>0 ,'label'=>"Wednesday MRT",'day_time'=>"Wednesday",'link'=>'https://dwagbipp.org/dwagmrtwednesdaynofee/'],

/* ----------  THURSDAY WOMEN’S BIPP (therapy_group.id = 3) ------ */
    ['program_id'=>3,'therapy_group_id'=>3,'fee'=>35,'label'=>"Thursday Women's BIPP",'day_time'=>"Thursday",'link'=>'https://dwagbipp.org/dwagbippthursdaywomen35/'],
    ['program_id'=>3,'therapy_group_id'=>3,'fee'=>25,'label'=>"Thursday Women's BIPP",'day_time'=>"Thursday",'link'=>'https://dwagbipp.org/dwagbippthursdaywomen25/'],
    ['program_id'=>3,'therapy_group_id'=>3,'fee'=>15,'label'=>"Thursday Women's BIPP",'day_time'=>"Thursday",'link'=>'https://dwagbipp.org/dwagbippthursdaywomen15/'],
    ['program_id'=>3,'therapy_group_id'=>3,'fee'=>10,'label'=>"Thursday Women's BIPP",'day_time'=>"Thursday",'link'=>'https://dwagbipp.org/dwagbippthursdaywomen10/'],
    ['program_id'=>3,'therapy_group_id'=>3,'fee'=>0 ,'label'=>"Thursday Women's BIPP",'day_time'=>"Thursday",'link'=>'https://dwagbipp.org/dwagbippthursdaywomennofee/'],
];
/* ====================  END DWAG GROUP DATA  ==================== */
...
<div class="container">
    <a href="https://dwagbipp.org/">
        <img alt="DWAG" src="dwaglogo.png" class="img-fluid mb-3">
    </a>
    ...
    <div class="modal-content p-3">
      ...
      <?php if ($clientProgramId === 2 || $clientProgramId === 3): ?>
        <p>
          ...
          <a href="https://dwagbipp.org/dwagbippintake/" target="_blank">
            Click Here
          </a>
        </p>
        <p>
          Virtual BIPP Intake Payment:
          <a href="https://dwagbipp.org/dwagbippintakepayment/" target="_blank">
            Click Here
          </a>
        </p>
      <?php endif; ?>
