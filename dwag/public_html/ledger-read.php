...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Ledger Record</title>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <h4>amount</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["amount"]); ?></p>
                        </div><div class="form-group">
                            <h4>create_date</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["create_date"]); ?></p>
                        </div><div class="form-group">
                            <h4>note</h4>
