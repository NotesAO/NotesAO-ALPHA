...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Referral Type Record</title>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            <h4>referral_type</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["referral_type"]); ?></p>
                        </div>

                    <p><a href="referral_type-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
