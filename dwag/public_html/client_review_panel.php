            ...
            <div class="row">
                <div class="col">
                    <div class="row">
                        ...
                        <div class="col-1">
                            <h5><a class="nav-link"
                                href="./client-victim.php?client_id=<?php echo htmlspecialchars($client_id); ?>">Victim&nbsp;Info</a></h5>
                        </div>                   
                    </div>
                </div>
            </div>
                ...
                <div class="col-5 pt-3 pb-3"> <!-- Client demographic info -->
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <?php
                            displayConduct('Excessive speaking', 'speaksSignificantlyInGroup', $client, 'true');
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <!-- Add a simple link or button to open the upload page -->
