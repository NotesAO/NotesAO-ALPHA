<?php
include '/home/notesao/dwag/public_html/auth.php';
...
// e.g. /home/notesao/NotePro-Report-Generator/templates/dwag
...
$script_paths = [
    ...
    "MRT" => [
        "Completion Documents"   => "$base_dir/MRT_Completion_Documents_Script.py",
        "Entrance Notifications" => "$base_dir/MRT_Entrance_Notifications_Script.py",
        "Exit Notices"           => "$base_dir/MRT_Exit_Notices_Script.py",
        "Unexcused Absences"     => "$base_dir/MRT_Unexcused_Absences_Script.py",
        "Progress Reports (Stage of Change)"=> "$base_dir/MRT_Progress_Reports_Script.py",
    ]
];
    ...
    $cmd = escapeshellcmd("$python_interpreter $script")
         ...
         if ($report_type === "Progress Reports (Curriculum)") {
            ...
            $cmd .= ' --db_host ' . escapeshellarg('50.28.37.79')
                  . ' --db_user ' . escapeshellarg('clinicnotepro_dwag_app')
                  . ' --db_pass ' . escapeshellarg('PF-m[T-+pF%g')
                  . ' --db_name ' . escapeshellarg('clinicnotepro_dwag');
        }
