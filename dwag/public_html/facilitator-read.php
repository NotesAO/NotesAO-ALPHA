...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Facilitator Record</title>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <h4>phone</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["phone"]); ?></p>
                        </div><div class="form-group">
                            <h4>licensure</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["licensure"]); ?></p>
                        </div>

                    <p><a href="facilitator-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
