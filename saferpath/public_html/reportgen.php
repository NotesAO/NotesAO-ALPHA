...
ini_set('error_log', '/home/notesao/saferpath/public_html/reportgen_errors.log');
...
// Logging details
$log_file = '/home/notesao/saferpath/public_html/reportgen_errors.log';
...
if (isset($_POST['action']) && $_POST['action'] === 'cleanup') {
    ...
    $public_dir   = "/home/notesao/saferpath/public_html/GeneratedDocuments/$today_date_formatted";
    $internal_dir = "/home/notesao/NotePro-Report-Generator/GeneratedDocuments/saferpath/$today_date_formatted";
    $zip_path     = "/home/notesao/saferpath/public_html/GeneratedDocuments/Generated_Reports_$today_date_formatted.zip";
...
<div class="container page-container">
    <h2 class="my-4 text-center">Report Generator for Safer Path</h2>
                ...
                <div class="form-row">
                    <div class="form-group col-sm-6 mb-3">
                        ...
                        >
                            ...
                            <option value="Thinking for a Change">Thinking for a Change</option>
                        </select>
                    </div>
                    <div class="form-group col-sm-6 mb-3">
