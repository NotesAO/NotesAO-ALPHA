...
define('db_name', 'clinicnotepro_transform');
define('db_user', 'clinicnotepro_transform_app');
...
<div class="container">
    <a href="https://www.transformprograms.com/">
        <img alt="Transform" src="transformlogo.png" class="img-fluid mb-3">
    </a>
    ...
    <div class="modal-content p-3">
      ...
      <?php if ($clientProgramId === 2 || $clientProgramId === 3): ?>
        <p>
          ...
          <a href="https://www.transformprograms.com/" target="_blank">
            Click Here
          </a>
        </p>
      <?php endif; ?>
