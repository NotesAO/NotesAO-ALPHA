        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_num_rows($result) == 1) {
                    ...
                    $identification_number      = htmlspecialchars($row["identification_number"]);
                    $identification_type_id     = htmlspecialchars($row["identification_type_id"]);
                    $other_id_type_description  = htmlspecialchars($row["other_id_type_description"]);
                    $referral_date              = htmlspecialchars($row["referral_date"]);
        ...
        <div class="container-fluid">
            ...
            <form autocomplete="off"
                            ...
                            <select class="form-control"
                                ...
                                <?php
                                    ...
                                    foreach ($genders as $gender) {
                                        ...
                                        $selected = ($gender["id"] == $gender_id) ? 'selected' : '';
                                        echo "<option value='{$gender['id']}' {$selected}>$value</option>";
                                    }
                                ?>
                            </select>
                            ...
                            <select class="form-control"
                                ...
                                <?php
                                    ...
                                    foreach ($ethnicities as $ethnicity) {
                                        ...
                                        $selected = ($ethnicity["id"] == $ethnicity_id) ? 'selected' : '';
                                        echo "<option value='{$ethnicity['id']}' {$selected}>$value</option>";
                                    }
                                ?>
                            </select>
                            ...
                            <select class="form-control"
                                ...
                                <?php
                                    ...
                                    foreach ($programs as $program) {
                                        ...
                                        $selected = ($program["id"] == $program_id) ? 'selected' : '';
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <input type="date"
                                   name="referral_date"
                                   class="form-control"
                                   value="<?php echo $referral_date; ?>">
                            <span class="form-text"><?php echo $referral_date_err; ?></span>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                ...
                <div class="col-2">
                    ...
                    <input type="text" name="identification_number" maxlength="128"
                            class="form-control"
                            value="<?= $identification_number; ?>">
                    <span class="form-text"><?= $identification_number_err; ?></span>
                    </div>
                </div>
                ...
                <div class="col-2">
                    ...
                    <select name="identification_type_id" class="form-control">
                        ...
                        <option value="<?= $t['id']; ?>"
                            <?= ($t['id'] == $identification_type_id) ? 'selected' : ''; ?>>
                            <?= htmlspecialchars($t['name']); ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                    <span class="form-text"><?= $identification_type_id_err; ?></span>
                    </div>
                </div>
                ...
                <div class="col-3">
                    ...
                    <input type="text" name="other_id_type_description" maxlength="128"
                            class="form-control"
                            value="<?= $other_id_type_description; ?>">
