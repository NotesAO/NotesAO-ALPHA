...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Curriculum Record</title>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <p class="form-control-static"><?php echo htmlspecialchars($row["short_description"]); ?></p>
                        </div><div class="form-group">
                            <h4>long_description</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["long_description"]); ?></p>
                        </div>

                    <p><a href="curriculum-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
