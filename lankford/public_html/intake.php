<?php
/**
 * lankford – BIPP Virtual Intake Packet
 * ------------------------------------
 * • GET  : render multi‑step form  (HTML follows this PHP section)
 * • POST : CSRF check → validate → INSERT into clinicnotepro_lankford.intake_packet
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $headers  = "From: reporting@lal.notesao.com\r\n";
    $headers .= "Reply-To: " . postv('email') . "\r\n";   // nice but optional
    $headers .= "X-Mailer: PHP/" . PHP_VERSION;

    @mail(
        ADMIN_ALERT_EMAIL,
        "Lankford Avenue Group has received a new Intake Packet for $fname $lname",
        "A new online intake packet was submitted.\n\nView pending & submitted packets:\nhttps://{$_SERVER['HTTP_HOST']}/intake-index.php",
        $headers,
        '-freporting@lal.notesao.com'            // ← some MTAs (esp. cPanel) require this
    );
...
if (!empty($_SESSION['show_thank_you_once'])) {
    ...
    <div class="jumbotron bg-white text-center shadow-sm py-4 mb-4">
      <a href="https://www.lankfordavenue.org/" target="_blank" rel="noopener">
        <img src="lankfordlogo.png" alt="Lankford Avenue"
    ...
    <div class="card shadow-sm">
      <div class="card-body text-center p-5">
        ...
        <a href="https://www.lankfordavenue.org/" class="btn btn-primary btn-lg">
          Lankford Avenue Home
        </a>
      </div>
    </div>
...
<head>
<meta charset="utf-8">
<title>Lankford Ave | BIPP Intake</title>
...
<!-- Jumbotron / Header Section -->
    <div class="jumbotron bg-white text-center shadow-sm py-4">
      <a href="https://www.lankfordavenue.org/" target="_blank">
        <!-- Responsive Image -->
          <img 
              src="lankfordlogo.png" 
              alt="Lankford Avenue" 
...
<form method="post">
  <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(csrf_token(),ENT_QUOTES) ?>">
    ...
    <p>If you have questions while filling out the form or encounter any technical difficulties, please contact our support team at: <strong></strong>.</p>
  ...
  <fieldset class="step">
    ...
    outside Lankford Avenue – BIPP. This right applies with the following exceptions:</p>
    ...
    <ul>
        ...
        <li><strong>Media involvement:</strong> Any media contact arranged by the Lankford Avenue Group program
            will include the presence of a Lankford Avenue Group employee to protect victim confidentiality.</li>
    </ul>

    <p><strong>We ask that you keep confidential information you may learn about other clients who are
    receiving services from Lankford Avenue – BIPP.</strong></p>

    <p><strong>Lankford Avenue Group requires facilitators and participants to:</strong></p>
    <ul>
    ...
    I accept these terms as a condition of participation in the Lankford Avenue – Batterers Intervention &amp;
  ...
  <fieldset class="step" id="step-client-consents">
    ...
    <div class="mb-4">
      ...
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        ...
        <p>I understand that I may revoke this consent at any time and that my request for revocation must be in writing. If not earlier revoked, this consent for disclosure of information shall expire 1 year after my completion of or termination from Lankford Avenue - Batterers Intervention & Prevention Program.</p>
        <p>I understand my right to confidentiality. I further understand that this consent form gives Lankford Avenue - BIPP permission to share confidential information about me in the way described above.</p>
        <p>I understand that Victim will be contacted by the Victim Advocate and offered counseling services. She/He will be provided enrollment, completion, or termination information from Lankford Avenue - BIPP.</p>
        <p>Release of information is voluntary; I understand I have a right to refuse Lankford Avenue - BIPP's request for this disclosure.</p>
        <p>Lankford Avenue - BIPP reserves the right to dismiss any client who refuses to meet the provisions of The Texas Department of Criminal Justice-Community Justice Assistance Division and Texas Council on Family Violence Battering Intervention & Prevention Project guidelines.</p>
      ...
      <div class="form-check">
        ...
        <label class="form-check-label" for="agree_disclosure">
          By checking "I Agree", I confirm that I have read, understood, and agree to abide by the terms and conditions outlined above. I acknowledge my rights and responsibilities as described, and I accept these terms as a condition of participation in the Lankford Avenue - Batterers Intervention & Prevention Program.
        </label>
      </div>
    </div>

    <!-- Section: Lankford Avenue Program Agreement -->
    <div class="mb-4">
      <label class="form-label fw-bold">Lankford Avenue Program Agreement</label>
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        <p>Fee per session is: Parole Intake Orientation $x, $x per group ($x total), $x Completion; Probation 18 Week – Intake Orientation $x, $x per group, $x Completion ($600 total); Probation 27 Week – Intake Orientation $x, $x per group, $x Completion ($600 total). This fee is only one type of demonstration of your accountability and restitution for violent behavior. Breaks, Assessment (intake), Orientation, or Exit Session are not to be included towards the 36 hours (18 weeks) or 54 hours (27 weeks).</p>
        <p>Battering Intervention and Prevention Program consists of Assessment (Intake) and Orientation and at least 36 hours of group sessions in a minimum of 24 weekly sessions. Not to exceed one session per week. If dismissed, the client must apply to re-enter into Lankford Avenue BIPP. Re-entry is considered on a case-by-case basis. I understand that I cannot re-enter the program until I have paid off my previous balance.</p>
        ...
        <p>You must be focused and facing your webcam during the entire group; <strong>NO</strong> watching TV or working on your computer. You will only be given one warning. Second warning will result in no credit for the session and/or a discharge violation from Lankford Avenue BIPP program.</p>
        <p>You must be in a quiet room; not driving, in your car, or doing any other activity. Otherwise, you will receive no credit for that BIPP session and/or receive a discharge violation from Lankford Avenue BIPP Program.</p>
        <p>If there is any interruption during your Lankford Avenue Group by a child or adult, you will lose credit for your class and/or receive a discharge violation from Lankford Avenue Program.</p>
        <p>If there is any appearance of alcohol or vaping during Lankford Avenue Group, it will result in a request for a drug test. If found dirty, you must sign a behavioral contract or be unsuccessfully discharged from Lankford Avenue BIPP Program.</p>
        <p>During your Lankford Avenue Group, if there is any woman present even for a moment, especially the victim, you shall receive no credit for the class and/or be unsuccessfully discharged from Lankford Avenue BIPP Program.</p>
        <p>If after a restroom break you do not return, or you take more than 5 minutes, you shall receive no credit for your Lankford Avenue BIPP Group session.</p>
        ...
        <p>I will notify Lankford Avenue BIPP of any change of address or phone number.</p>
        <p>I hereby agree to contact BIPP by phone at  when I am unable to attend a scheduled session. Failure to contact Lankford Avenue within 2 consecutive absences is an automatic discharge from Lankford Avenue Program.</p>
        ...
        <p>I understand that Lankford Avenue BIPP is committed to helping me gain a better understanding of my problems and how to find productive solutions and that it is the main goal of my psychoeducational classes.</p>
      </div>
      <div class="form-check">
    ...
    <div class="mb-4">
      ...
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        ...
        <p>Lankford Avenue Group requires me to disable any devices that could collect information from the environment, such as Google Home Assistant, Amazon Alexa, or Apple Siri, and I agree that I will not record nor take screenshots of the group. Lankford Avenue Group requires me to be in a private space and not in any public area such as a park, yard, or open area; other people not in the group should not be exposed to the content nor hear or observe the group.</p>
    ...
    <div class="mb-4">
      ...
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        <p>I have received a copy of the "Policy for Clients" for Lankford Avenue - BIPP. I understand my rights and responsibilities, and I agree to enter Lankford Avenue - BIPP.</p>
        <p>I understand that in accordance with Guideline 31 of the Texas Department of Criminal Justice-Community Justice Assistance Division and Texas Council on Family Violence Battering Intervention Prevention Program guidelines, I am being provided a written agreement that clearly delineates the obligation of the Lankford Avenue - BIPP to the client. I understand that the Lankford Avenue - BIPP shall:</p>
        <ul>
        ...
        <ul>
          ...
          <li>Lankford Avenue - BIPP client violates any of the BIPP rules.</li>
        </ul>
        ...
        <p>Clients have the right to seek other resources outside of Lankford Avenue - BIPP, and when possible, Lankford Avenue - BIPP staff will provide or make a referral.</p>
        ...
        <p>Lankford Avenue - BIPP will provide batterers at the time of assessment (intake) with a copy of the circumstances under which they can be terminated before completion.</p>
        <p>I have read and understand the above statements and voluntarily enter into counseling services from the staff of Lankford Avenue Group - BIPP - by entering my name below. (By clicking SUBMIT, I hereby confirm the above information to the best of my knowledge is correct and true, with no misleading or false content in accordance with Texas Perjury Statute, Sec. 37.02 (a) (2) Chapter 32, Civil Practice and Remedies Code.)</p>
      </div>
      <div class="form-check">
