...
define('db_name', 'clinicnotepro_lankford');
define('db_user', 'clinicnotepro_lankford_app');
...
<div class="container">
    <a href="https://www.lankfordavenue.org/">
        <img alt="Lankford Avenue" src="lankfordlogo.png" class="img-fluid mb-3">
    </a>
