...
ALTER TABLE `therapy_session`
  ...
  ADD KEY `fk_therapy_session_instructors` (`instructors_id`);
...
ALTER TABLE `therapy_session`
  ...
  ADD CONSTRAINT `fk_therapy_session_instructors` FOREIGN KEY (`instructors_id`) REFERENCES `instructors` (`id`),
