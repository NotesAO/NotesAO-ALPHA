...
<div class="container-xl mt-4">
    ...
    <div class="jumbotron bg-white text-center shadow-sm py-4">
        ...
        <h1 class="display-5">Welcome to NotesAO</h1>
        <p class="lead">Your Clinic Dashboard at a Glance</p>
        <img 
            src="ctclogo.png" 
            alt="CTC" 
    ...
    <div class="card border-secondary mb-5">
        ...
        <div class="card-body">
            ...
            <!-- Program Switch, MAR Report, and Upload Documents in a Row -->
            <div class="row mt-3">
                <!-- Program Switch Form (Left-Aligned) -->
                <div class="col-md-6 d-flex align-items-center">
                    <form action="home.php" method="POST" class="form-inline">
                        <input type="hidden" name="action" value="switch_program">
                        
                        <div class="form-group mb-2 mr-2">
                            <label for="switch_program_id" class="mr-2">Current Program:</label>
                            <select name="switch_program_id" id="switch_program_id" class="form-control">
                                <?php
                                foreach ($hardcoded_programs as $pid => $pname) {
                                    $selected = ($pid == $program_id) ? 'selected' : '';
                ...
                <div class="col-md-3 text-right">
                    <button type="button" class="btn btn-warning btn-md btn-block" onclick="showMarModal();">
                ...
                <div class="col-md-3 text-right">
                    <a href="officedocuments.php" class="btn btn-md btn-block" 
                    style="background-color: #6c757d; border-color: #545b62; color: white;"
                    onmouseover="this.style.backgroundColor='#5a6268'; this.style.borderColor='#4e555b';"
                    onmouseout="this.style.backgroundColor='#6c757d'; this.style.borderColor='#545b62';">
    ...
    <div class="row">
                ...
                <div id="missingInfoContent" style="max-height:805px; overflow:hidden; transition:max-height 0.4s ease;">
                    ...
                    LEFT JOIN exit_reason e   ON c.exit_reason_id = e.id
                        ...
                        AND (
                            ...
                            OR (c.gender_id = 1)
                            OR (c.required_sessions NOT IN (8,10,12,18,27,30,32,39,52))
                        )
                        ORDER BY p.name, c.last_name
                    ";
                    ...
                    if ($resMissing = $con->query($sqlMissing)) {
                        if ($resMissing->num_rows > 0) {
                            ...
                            while ($row = $resMissing->fetch_assoc()) {
                                ...
                                if (!in_array($row['required_sessions'], [8,10,12,18,27,30,32,39,52]) &&
        ...
        <div class="card border-dark">
            ...
            <div class="card-body p-2">
                ...
                $baselineTs   = '2025-05-14 11:33:10';
