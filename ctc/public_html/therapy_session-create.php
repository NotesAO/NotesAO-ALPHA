...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO therapy_session (therapy_group_id,date,duration_minutes,curriculum_id,instructors_id,note) VALUES (?,?,?,?,?,?)");

        if($stmt->execute([ $therapy_group_id,$date,$duration_minutes,$curriculum_id,$instructors_id,$note  ])) {
                $stmt = null;
