...
define('db_name', 'clinicnotepro_ctc');
define('db_user', 'clinicnotepro_ctc_app');
...
<div class="container">
    <a href="https://www.ctchange.org/">
        <img alt="CTC" src="ctclogo.png" class="img-fluid mb-3">
    </a>
    ...
    <div class="modal-content p-3">
      ...
      <?php if ($clientProgramId === 2 || $clientProgramId === 3): ?>
        <p>
          ...
          <a href="https://www.ctchange.org/" target="_blank">
            Click Here
          </a>
        </p>
      <?php endif; ?>
