    ...
    <section class="pt-3">
        <div class="container-fluid">
            ...
            $select_clause = "SELECT
                    ...
                    concat(f.first_name, ' ', f.last_name) instructors,
                    c.short_description curriculum,
                    ifnull(attendance_count.num_attended, 0) num_attended,
                    s.note session_note
                FROM
                    therapy_session s
                JOIN therapy_group g ON
                    s.therapy_group_id = g.id
                LEFT OUTER JOIN instructors f ON
                    s.instructors_id = f.id
            ...
            if ($result = mysqli_query($link, $sql)) {
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td>" . htmlspecialchars($row['instructors']) . "</td>";
