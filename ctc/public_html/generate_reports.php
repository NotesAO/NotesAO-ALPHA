<?php
include '/home/notesao/ctc/public_html/auth.php';
...
// e.g. /home/notesao/NotePro-Report-Generator/templates/ctc
...
$valid_programs = ["BIPP", "Anger Control", "TIPS"];
...
$script_paths = [
    ...
    "TIPS" => [
        "Completion Documents"   => "$base_dir/TIPS_Completion_Documents_Script.py",
        "Entrance Notifications" => "$base_dir/TIPS_Entrance_Notifications_Script.py",
        "Exit Notices"           => "$base_dir/TIPS_Exit_Notices_Script.py",
        "Unexcused Absences"     => "$base_dir/TIPS_Unexcused_Absences_Script.py",
        "Progress Reports (Stage of Change)"=> "$base_dir/TIPS_Progress_Reports_Script.py",
        "Progress Reports (Curriculum)"=> "$base_dir/TIPS_Progress_Reports_Script.py"
    ]
];
    ...
    $cmd = escapeshellcmd("$python_interpreter $script")
         ...
         if ($report_type === "Progress Reports (Curriculum)") {
            ...
            $cmd .= ' --db_host ' . escapeshellarg('50.28.37.79')
                  . ' --db_user ' . escapeshellarg('clinicnotepro_ctc_app')
                  . ' --db_pass ' . escapeshellarg('PF-m[T-+pF%g')
                  . ' --db_name ' . escapeshellarg('clinicnotepro_ctc');
        }
