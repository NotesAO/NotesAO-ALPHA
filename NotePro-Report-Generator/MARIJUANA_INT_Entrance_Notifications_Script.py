...
parser = argparse.ArgumentParser(description='Generate Marijuana Intervention Entrance Notifications')
...
# Template path
template_path = os.path.join(templates_dir, 'Template.MARIJUANA INT Entrance Notification.docx')
...
# Filter by Marijuana Intervention (male/female)
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            docx_filename = f"{last_name} {first_name} MARI INT Entrance.docx"
