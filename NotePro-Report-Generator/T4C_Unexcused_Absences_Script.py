...
##############################################################################
parser = argparse.ArgumentParser(description='Generate T4C Unexcused Absences Notifications')
...
logging.basicConfig(
    filename=os.path.join(log_dir, f'T4C_Unexcused_Absences_{datetime.now().strftime("%Y%m%d")}.log'),
    level=logging.DEBUG,
    format='%(asctime)s [%(levelname)s] %(message)s'
)
logging.info("T4C Unexcused Absences Script started.")
...
##############################################################################
template_file_path = os.path.join(templates_dir, 'Template.T4C Unexcused Absence.docx')
...
if df.empty:
    message = "T4C Unexcused Absences Script completed: No absences found within the given date range."
...
def generate_documents_for_row(row):
    ...
    docx_filename = f"{last_name} {first_name} T4C Unexcused Absence.docx"
...
logging.info("T4C Unexcused Absence documents have been generated and organized.")
print("T4C Unexcused Absence documents have been generated and organized.")
