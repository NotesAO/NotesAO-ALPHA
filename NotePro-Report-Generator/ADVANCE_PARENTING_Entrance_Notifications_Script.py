...
parser = argparse.ArgumentParser(description='Generate ADV PARENTING Entrance Notifications')
...
# Template path
template_path = need_template('Template.ADV PARENTING Entrance Notification.docx')
...
# Filter by ADV PARENTING (male/female)
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            docx_filename = f"{last_name} {first_name} ADV PARENTING Entrance.docx"
