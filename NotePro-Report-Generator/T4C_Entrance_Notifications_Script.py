...
##############################################################################
parser = argparse.ArgumentParser(description='Generate T4C Entrance Notifications')
...
logging.basicConfig(
    filename=os.path.join(log_dir, f'T4C_Entrance_Notifications_{datetime.now().strftime("%Y%m%d")}.log'),
    level=logging.DEBUG,
    format='%(asctime)s [%(levelname)s] %(message)s'
)
logging.info("T4C Entrance Notifications Script started.")
...
##############################################################################
template_path = os.path.join(templates_dir, 'Template.T4C Entrance Notification.docx')
...
# Filter: T4C + 'Not Exited' + orientation_date in [start_date, end_date]
...
def generate_documents_for_row(row):
    """
    Generate a single PDF per row: T4C Entrance Notification.
    ...
    docx_filename = f"{last_name} {first_name} T4C Entrance.docx"
    ...
    try:
        ...
        logging.error(f"Error creating or moving T4C Entrance doc for row: {e}")
...
logging.info("T4C Entrance Notifications have been generated and organized.")
print("T4C Entrance Notifications have been generated and organized.")
