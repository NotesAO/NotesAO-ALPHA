...
# ------------------------------
template_file_path = resolve_template(_TEMPLATES_ROOT, clinic_folder, program_code, 'Template.AC Progress Report.docx')
if not template_file_path:
    record_error(f"[FATAL] Missing template Template.AC Progress Report.docx under clinic/default fallbacks in {_TEMPLATES_ROOT}.")
