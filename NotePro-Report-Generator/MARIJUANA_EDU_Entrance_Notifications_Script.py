...
parser = argparse.ArgumentParser(description='Generate Marijuana Education Entrance Notifications')
...
# Template path
template_path = os.path.join(templates_dir, 'Template.MARIJUANA EDU Entrance Notification.docx')
...
# Filter by Marijuana Education (male/female)
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            docx_filename = f"{last_name} {first_name} MARIJUANA EDU Entrance.docx"
