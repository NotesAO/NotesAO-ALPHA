...
completion_certificate_file_path = os.path.join(templates_dir, 'Template.DWIE Completion Certificate.docx')
completion_letter_file_path = os.path.join(templates_dir, 'Template.DWIE Completion Letter.docx')
completion_report_file_path = os.path.join(templates_dir, 'Template.DWIE Completion Progress Report.docx')
completion_virtual_report_file_path = os.path.join(templates_dir, 'Template.DWIE Completion Progress Report Virtual.docx')
