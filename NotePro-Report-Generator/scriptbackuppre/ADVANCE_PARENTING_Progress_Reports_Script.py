...
progress_report_template_path = os.path.join(templates_dir, 'Template.ADV PARENTING Progress Report.docx')
virtual_progress_report_template_path = os.path.join(templates_dir, 'Template.ADV PARENTING Progress Report Virtual.docx')
