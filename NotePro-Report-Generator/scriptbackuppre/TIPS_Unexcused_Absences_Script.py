...
##############################################################################
parser = argparse.ArgumentParser(description='Generate TIPS Unexcused Absences Notifications')
...
logging.basicConfig(
    filename=os.path.join(log_dir, f'TIPS_Unexcused_Absences_{datetime.now().strftime("%Y%m%d")}.log'),
    level=logging.DEBUG,
    format='%(asctime)s [%(levelname)s] %(message)s'
)
logging.info("TIPS Unexcused Absences Script started.")
...
##############################################################################
template_file_path = os.path.join(templates_dir, 'Template.TIPS Unexcused Absence.docx')
...
if df.empty:
    message = "TIPS Unexcused Absences Script completed: No absences found within the given date range."
...
def generate_documents_for_row(row):
    ...
    docx_filename = f"{last_name} {first_name} TIPS Unexcused Absence.docx"
...
logging.info("TIPS Unexcused Absence documents have been generated and organized.")
print("TIPS Unexcused Absence documents have been generated and organized.")
