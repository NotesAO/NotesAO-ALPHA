...
parser = argparse.ArgumentParser(description='Generate WEST Entrance Notifications')
...
# Template path
template_path = os.path.join(templates_dir, 'Template.WEST Entrance Notification.docx')
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            docx_filename = f"{last_name} {first_name} WEST Entrance.docx"
