...
# ------------------------------------------------------------------------------
behavior_contract_template_path = os.path.join(templates_dir, 'Template.BIPP Behavior Contract.docx')
...
logging.info("BIPP Behavior Contract Script completed successfully.")
