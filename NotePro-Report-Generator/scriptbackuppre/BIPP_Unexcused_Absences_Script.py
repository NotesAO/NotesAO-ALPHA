...
# Template path
template_file_path = os.path.join(templates_dir, 'Template.BIPP Unexcused Absence.docx')
...
def generate_documents(row, output_dir_path):
    ...
    try:
        ...
        docx_filename = f"{last_name} {first_name} BIPP Unexcused Absence.docx"
...
logging.info("BIPP Unexcused Absences Script completed successfully.")
