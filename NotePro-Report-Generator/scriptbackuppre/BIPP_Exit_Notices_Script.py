...
exit_notice_template_path = os.path.join(templates_dir, 'Template.BIPP Exit Notice.docx')
progress_report_template_path = os.path.join(templates_dir, 'Template.BIPP Exit Progress Report.docx')
virtual_progress_report_template_path = os.path.join(templates_dir, 'Template.BIPP Exit Progress Report Virtual.docx')
...
logging.info("BIPP Exit Notices Script completed successfully.")
