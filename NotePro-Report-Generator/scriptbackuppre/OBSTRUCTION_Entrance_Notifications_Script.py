...
parser = argparse.ArgumentParser(description='Generate OBSTRUCTION Entrance Notifications')
...
# Template path
template_path = os.path.join(templates_dir, 'Template.OBSTRUCTION Entrance Notification.docx')
...
# Filter by OBSTRUCTION (male/female)
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            docx_filename = f"{last_name} {first_name} OBSTRUCTION Entrance.docx"
