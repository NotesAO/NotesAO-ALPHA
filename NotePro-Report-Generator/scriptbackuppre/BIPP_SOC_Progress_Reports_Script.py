...
progress_report_template_path = os.path.join(templates_dir, 'Template.BIPP SOC Progress Report.docx')
virtual_progress_report_template_path = os.path.join(templates_dir, 'Template.BIPP SOC Progress Report Virtual.docx')
...
logging.info("BIPP Progress Reports Script completed successfully.")
