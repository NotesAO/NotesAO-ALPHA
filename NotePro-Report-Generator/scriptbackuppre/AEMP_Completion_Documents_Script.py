...
completion_certificate_file_path = os.path.join(templates_dir, 'Template.AEMP Completion Certificate.docx')
completion_letter_file_path = os.path.join(templates_dir, 'Template.AEMP Completion Letter.docx')
completion_report_file_path = os.path.join(templates_dir, 'Template.AEMP Completion Progress Report.docx')
completion_virtual_report_file_path = os.path.join(templates_dir, 'Template.AEMP Completion Progress Report Virtual.docx')
