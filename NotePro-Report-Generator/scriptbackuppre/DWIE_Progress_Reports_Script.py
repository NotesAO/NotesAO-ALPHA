...
progress_report_template_path = os.path.join(templates_dir, 'Template.DWIE Progress Report.docx')
virtual_progress_report_template_path = os.path.join(templates_dir, 'Template.DWIE Progress Report Virtual.docx')
