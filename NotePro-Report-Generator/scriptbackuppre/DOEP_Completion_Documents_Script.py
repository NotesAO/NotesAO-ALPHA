...
completion_certificate_file_path = os.path.join(templates_dir, 'Template.DOEP Completion Certificate.docx')
completion_letter_file_path = os.path.join(templates_dir, 'Template.DOEP Completion Letter.docx')
completion_report_file_path = os.path.join(templates_dir, 'Template.DOEP Completion Progress Report.docx')
completion_virtual_report_file_path = os.path.join(templates_dir, 'Template.DOEP Completion Progress Report Virtual.docx')
