...
##############################################################################
parser = argparse.ArgumentParser(description='Generate TIPS Entrance Notifications')
...
logging.basicConfig(
    filename=os.path.join(log_dir, f'TIPS_Entrance_Notifications_{datetime.now().strftime("%Y%m%d")}.log'),
    level=logging.DEBUG,
    format='%(asctime)s [%(levelname)s] %(message)s'
)
logging.info("TIPS Entrance Notifications Script started.")
...
##############################################################################
template_path = os.path.join(templates_dir, 'Template.TIPS Entrance Notification.docx')
...
# Filter: TIPS + 'Not Exited' + orientation_date in [start_date, end_date]
...
def generate_documents_for_row(row):
    """
    Generate a single PDF per row: TIPS Entrance Notification.
    ...
    docx_filename = f"{last_name} {first_name} TIPS Entrance.docx"
    ...
    try:
        ...
        logging.error(f"Error creating or moving TIPS Entrance doc for row: {e}")
...
logging.info("TIPS Entrance Notifications have been generated and organized.")
print("TIPS Entrance Notifications have been generated and organized.")
