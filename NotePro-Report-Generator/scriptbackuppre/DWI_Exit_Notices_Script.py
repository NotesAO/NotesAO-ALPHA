...
exit_notice_template_path = os.path.join(templates_dir, 'Template.DWI Exit Notice.docx')
progress_report_template_path = os.path.join(templates_dir, 'Template.DWI Exit Progress Report.docx')
virtual_progress_report_template_path = os.path.join(templates_dir, 'Template.DWI Exit Progress Report Virtual.docx')
...
def generate_documents(row, output_dir_path):
    ...
    progress_pdf = render_and_save(report_template, f"DWI {report_suffix}", context, output_dir_path)
