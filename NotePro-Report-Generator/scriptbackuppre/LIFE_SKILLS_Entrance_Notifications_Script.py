...
parser = argparse.ArgumentParser(description='Generate Life Skills Entrance Notifications')
...
# Template path
template_path = os.path.join(templates_dir, 'Template.LIFE SKILLS Entrance Notification.docx')
...
# Filter by Life Skills (male/female)
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            docx_filename = f"{last_name} {first_name} Life Skills Entrance.docx"
