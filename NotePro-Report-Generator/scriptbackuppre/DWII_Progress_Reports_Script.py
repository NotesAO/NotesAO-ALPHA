...
progress_report_template_path = os.path.join(templates_dir, 'Template.DWII Progress Report.docx')
virtual_progress_report_template_path = os.path.join(templates_dir, 'Template.DWII Progress Report Virtual.docx')
