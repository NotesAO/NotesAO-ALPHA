...
parser = argparse.ArgumentParser(description='Generate PARENTING Entrance Notifications')
...
# Template path
template_path = os.path.join(templates_dir, 'Template.PARENTING Entrance Notification.docx')
...
# Filter by PARENTING (male/female)
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            docx_filename = f"{last_name} {first_name} PARENTING Entrance.docx"
