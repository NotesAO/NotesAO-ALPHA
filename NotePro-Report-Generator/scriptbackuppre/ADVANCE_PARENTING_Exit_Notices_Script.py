...
exit_notice_template_path = os.path.join(templates_dir, 'Template.ADV PARENTING Exit Notice.docx')
progress_report_template_path = os.path.join(templates_dir, 'Template.ADV PARENTING Exit Progress Report.docx')
virtual_progress_report_template_path = os.path.join(templates_dir, 'Template.ADV PARENTING Exit Progress Report Virtual.docx')
