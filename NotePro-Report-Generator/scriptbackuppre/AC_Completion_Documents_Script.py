...
# -----------------------------------------------------------
completion_letter_template_path = os.path.join(templates_dir, 'Template.AC Completion Letter.docx')
completion_certificate_template_path = os.path.join(templates_dir, 'Template.AC Completion Certificate.docx')
completion_report_template_path = os.path.join(templates_dir, 'Template.AC Completion Progress Report.docx')
