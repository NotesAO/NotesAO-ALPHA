...
# ------------------------------
exit_notice_template_path = os.path.join(templates_dir, 'Template.AC Exit Notice.docx')
progress_report_template_path = os.path.join(templates_dir, 'Template.AC Exit Progress Report.docx')
...
def generate_documents_for_row(row):
    ...
    exit_pdf = render_and_save(exit_notice_template_path, "AC Exit Notice", context)
    # 2) Generate AC Exit Progress Report
    progress_pdf = render_and_save(progress_report_template_path, "AC Exit PReport", context)
