...
exit_notice_template_path = os.path.join(templates_dir, 'Template.DWII Exit Notice.docx')
progress_report_template_path = os.path.join(templates_dir, 'Template.DWII Exit Progress Report.docx')
virtual_progress_report_template_path = os.path.join(templates_dir, 'Template.DWII Exit Progress Report Virtual.docx')
...
def generate_documents(row, output_dir_path):
    ...
    exit_pdf = render_and_save(exit_notice_template_path, "DWII Exit Notice", context, output_dir_path)
    # Generate Exit Progress Report
    progress_pdf = render_and_save(report_template, f"DWII {report_suffix}", context, output_dir_path)
