# Life Skills_Enrollment_Letters_Script.py
import pandas as pd
...
CANDIDATE_TEMPLATES = [
    ...
    'Template.LIFE SKILLS Enrollment Letter.docx',
    'Template.LIFE SKILLS Enroll.docx',
    'Template.LIFE SKILLS Entrance Notification.docx',  # last-resort fallback
]
template_path = None
