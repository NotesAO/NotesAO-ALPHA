...
parser = argparse.ArgumentParser(description='Generate DWII Completion Documents')
...
completion_certificate_file_path    = need_template('Template.DWII Completion Certificate.docx')
completion_letter_file_path         = need_template('Template.DWII Completion Letter.docx')
completion_report_file_path         = need_template('Template.DWII Completion Progress Report.docx')
completion_virtual_report_file_path = need_template('Template.DWII Completion Progress Report Virtual.docx')
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            if completion_letter_file_path:
                letter_docx = render_and_save(completion_letter_file_path, "DWII Comp Letter", context, generated_documents_dir)

            if completion_certificate_file_path:
                cert_docx = render_and_save(completion_certificate_file_path, "DWII Comp Cert", context, generated_documents_dir)
            ...
            if progress_template:
                progress_docx = render_and_save(progress_template, "DWII Comp PReport", context, generated_documents_dir)
