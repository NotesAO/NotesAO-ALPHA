...
parser = argparse.ArgumentParser(description='Generate DOEP Entrance Notifications')
...
# Template path
template_path = resolve_template(_TEMPLATES_ROOT, clinic_folder, program_code, 'Template.DOEP Entrance Notification.docx')
if not template_path:
    record_error(f"[FATAL] Missing template Template.DOEP Entrance Notification.docx under clinic/default fallbacks in {_TEMPLATES_ROOT}.")
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            docx_filename = f"{last_name} {first_name} DOEP Entrance.docx"
