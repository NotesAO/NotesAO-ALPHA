...
parser = argparse.ArgumentParser(description='Generate IOP Entrance Notifications')
...
# Template path
template_path = need_template('Template.IOP Entrance Notification.docx')
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        if not template_path:
            logging.warning("No tempalte resolved; skipping generation.")
            sys.exit(0)
        try:
            ...
            docx_filename = f"{last_name} {first_name} IOP Entrance.docx"
