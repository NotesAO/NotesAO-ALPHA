...
parser = argparse.ArgumentParser(description='Generate DWII Entrance Notifications')
...
# Template path
template_path = need_template('Template.DWII Entrance Notification.docx')
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            docx_filename = f"{last_name} {first_name} DWII Entrance.docx"
