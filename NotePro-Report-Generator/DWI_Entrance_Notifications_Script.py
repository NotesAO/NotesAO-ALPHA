...
parser = argparse.ArgumentParser(description='Generate DWI Entrance Notifications')
...
# Template path
template_path = need_template('Template.DWI Entrance Notification.docx')
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            docx_filename = f"{last_name} {first_name} DWI Entrance.docx"
