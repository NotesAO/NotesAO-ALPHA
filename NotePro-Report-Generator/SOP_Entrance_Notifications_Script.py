...
parser = argparse.ArgumentParser(description='Generate SOP Entrance Notifications')
...
# Template path
template_path = os.path.join(templates_dir, 'Template.SOP Entrance Notification.docx')
...
if df_filtered.empty:
    ...
    for index, row in df_filtered.iterrows():
        try:
            ...
            docx_filename = f"{last_name} {first_name} SOP Entrance.docx"
