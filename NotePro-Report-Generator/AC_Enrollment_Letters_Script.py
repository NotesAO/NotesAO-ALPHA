...
CANDIDATE_TEMPLATES = [
    ...
    'Template.AC Enrollment Letter.docx',
    'Template.AC Enroll.docx',
    'Template.AC Entrance Notification.docx',  # last-resort fallback
]
template_path = None
...
if not template_path:
    ...
    # soft-stop: nothing to generate, but do not crash
    sys.exit(0)
