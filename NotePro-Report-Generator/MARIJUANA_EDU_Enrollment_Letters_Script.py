# MARIJAUNA_EDUCATION_Enrollment_Letters_Script.py
import pandas as pd
...
CANDIDATE_TEMPLATES = [
    ...
    'Template.MARIJUANA EDU Enrollment Letter.docx',
    'Template.MARIJUANA EDU Enroll.docx',
    'Template.MARIJUANA EDU Entrance Notification.docx',  # last-resort fallback
]
template_path = None
...
if not template_path:
    logging.error(f"No enrollment DOCX template found in {templates_dir}. Tried: {CANDIDATE_TEMPLATES}")
    sys.exit(1)
