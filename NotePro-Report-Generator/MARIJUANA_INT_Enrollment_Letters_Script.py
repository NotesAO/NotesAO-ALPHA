# MARI_INT_Enrollment_Letters_Script.py
import pandas as pd
...
CANDIDATE_TEMPLATES = [
    ...
    'Template.MARIJUANA INT Enrollment Letter.docx',
    'Template.MARIJUANA INT Enroll.docx',
    'Template.MARIJUANA INT Entrance Notification.docx',  # last-resort fallback
]
template_path = None
