...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Image View</title>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            <h4>image_data</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["image_data"]); ?></p>
                        </div>

                    <p><a href="image-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
