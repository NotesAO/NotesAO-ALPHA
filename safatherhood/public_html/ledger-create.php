<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO ledger (client_id,amount,create_date,note) VALUES (?,?,?,?)");

        if($stmt->execute([ $client_id,$amount,$create_date,$note  ])) {
            $stmt = null;
...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Ledger Create</title>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group">
                                <label>client_id</label>
                                    ...
                                    <select class="form-control" id="client_id_select" name="client_id_select" disabled="true">
                                    <?php
						...
						<div class="form-group">
                                <label>amount</label> <small class="text-muted">(Negative values indicate charge, Positive values indicate payments)</small>
