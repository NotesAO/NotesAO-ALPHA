...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO attendance_record (client_id,therapy_session_id,note) VALUES (?,?,?)");

        if($stmt->execute([ $client_id,$therapy_session_id,$note  ])) {
                $stmt = null;
...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Client Attendance Create</title>
