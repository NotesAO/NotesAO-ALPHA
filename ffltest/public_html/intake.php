<?php
/**
 * FFLTEST – BIPP Virtual Intake Packet
 * ------------------------------------
 * • GET  : render multi‑step form  (HTML follows this PHP section)
 * • POST : CSRF check → validate → INSERT into clinicnotepro_ffltest.intake_packet
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    @mail(
        ADMIN_ALERT_EMAIL,
        "Free for Life Group has received a new Intake Packet for $fname $lname",
...
<!-- Jumbotron / Header Section -->
    <div class="jumbotron bg-white text-center shadow-sm py-4">
      <a href="https://freeforlifegroup.com" target="_blank">
        <!-- Responsive Image -->
          <img 
              src="ffllogo.png" 
              alt="Free for Life Group" 
...
<form method="post">
  <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(csrf_token(),ENT_QUOTES) ?>">
    ...
    <p>If you have questions while filling out the form or encounter any technical difficulties, please contact our support team at: <strong>(817) 501-5102</strong>.</p>
  ...
  <fieldset class="step">
    ...
    outside Free for Life Group – BIPP. This right applies with the following exceptions:</p>
    ...
    <ul>
        ...
        <li><strong>Media involvement:</strong> Any media contact arranged by the Free for Life Group program
            will include the presence of a Free for Life Group employee to protect victim confidentiality.</li>
    </ul>

    <p><strong>We ask that you keep confidential information you may learn about other clients who are
    receiving services from Free for Life – BIPP.</strong></p>

    <p><strong>Free for Life Group requires facilitators and participants to:</strong></p>
    <ul>
    ...
    I accept these terms as a condition of participation in the Free for Life – Batterers Intervention &amp;
  ...
  <fieldset class="step" id="step-client-consents">
    ...
    <div class="mb-4">
      ...
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        ...
        <p>I understand that I may revoke this consent at any time and that my request for revocation must be in writing. If not earlier revoked, this consent for disclosure of information shall expire 1 year after my completion of or termination from Free for Life - Batterers Intervention & Prevention Program.</p>
        <p>I understand my right to confidentiality. I further understand that this consent form gives Free for Life - BIPP permission to share confidential information about me in the way described above.</p>
        <p>I understand that Victim will be contacted by the Victim Advocate and offered counseling services. She/He will be provided enrollment, completion, or termination information from Free for Life - BIPP.</p>
        <p>Release of information is voluntary; I understand I have a right to refuse Free for Life - BIPP's request for this disclosure.</p>
        <p>Free for Life - BIPP reserves the right to dismiss any client who refuses to meet the provisions of The Texas Department of Criminal Justice-Community Justice Assistance Division and Texas Council on Family Violence Battering Intervention & Prevention Project guidelines.</p>
      ...
      <div class="form-check">
        ...
        <label class="form-check-label" for="agree_disclosure">
          By checking "I Agree", I confirm that I have read, understood, and agree to abide by the terms and conditions outlined above. I acknowledge my rights and responsibilities as described, and I accept these terms as a condition of participation in the Free for Life - Batterers Intervention & Prevention Program.
        </label>
      </div>
    </div>

    <!-- Section: Free for Life Program Agreement -->
    <div class="mb-4">
      <label class="form-label fw-bold">Free for Life Program Agreement</label>
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        ...
        <p>You must be focused and facing your webcam during the entire group; <strong>NO</strong> watching TV or working on your computer. You will only be given one warning. Second warning will result in no credit for the session and/or a discharge violation from Free for Life BIPP program.</p>
        <p>You must be in a quiet room; not driving, in your car, or doing any other activity. Otherwise, you will receive no credit for that BIPP session and/or receive a discharge violation from Free for Life BIPP Program.</p>
        <p>If there is any interruption during your Free for Life Group by a child or adult, you will lose credit for your class and/or receive a discharge violation from Free for Life Program.</p>
        <p>If there is any appearance of alcohol or vaping during Free for Life Group, it will result in a request for a drug test. If found dirty, you must sign a behavioral contract or be unsuccessfully discharged from Free for Life BIPP Program.</p>
        <p>During your Free for Life Group, if there is any woman present even for a moment, especially the victim, you shall receive no credit for the class and/or be unsuccessfully discharged from Free for Life BIPP Program.</p>
        <p>If after a restroom break you do not return, or you take more than 5 minutes, you shall receive no credit for your Free for Life BIPP Group session.</p>
        ...
        <p>I will notify Free for Life BIPP of any change of address or phone number.</p>
        <p>I hereby agree to contact BIPP by phone at 817-501-5102 when I am unable to attend a scheduled session. Failure to contact Free for Life within 2 consecutive absences is an automatic discharge from Free for Life Program.</p>
        ...
        <p>I understand that Free for Life BIPP is committed to helping me gain a better understanding of my problems and how to find productive solutions and that it is the main goal of my psychoeducational classes.</p>
      </div>
      <div class="form-check">
    ...
    <div class="mb-4">
      ...
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        ...
        <p>Free for Life Group requires me to disable any devices that could collect information from the environment, such as Google Home Assistant, Amazon Alexa, or Apple Siri, and I agree that I will not record nor take screenshots of the group. Free for Life Group requires me to be in a private space and not in any public area such as a park, yard, or open area; other people not in the group should not be exposed to the content nor hear or observe the group.</p>
    ...
    <div class="mb-4">
      ...
      <div class="border p-3 mb-2 rounded overflow-auto" style="max-height: 240px; background-color: #f8f9fa;">
        <p>I have received a copy of the "Policy for Clients" for Free for Life - BIPP. I understand my rights and responsibilities, and I agree to enter Free for Life - BIPP.</p>
        <p>I understand that in accordance with Guideline 31 of the Texas Department of Criminal Justice-Community Justice Assistance Division and Texas Council on Family Violence Battering Intervention Prevention Program guidelines, I am being provided a written agreement that clearly delineates the obligation of the Free for Life - BIPP to the client. I understand that the Free for Life - BIPP shall:</p>
        <ul>
        ...
        <ul>
          ...
          <li>Free for Life - BIPP client violates any of the BIPP rules.</li>
        </ul>
        ...
        <p>Clients have the right to seek other resources outside of Free for Life - BIPP, and when possible, Free for Life - BIPP staff will provide or make a referral.</p>
        ...
        <p>Free for Life - BIPP will provide batterers at the time of assessment (intake) with a copy of the circumstances under which they can be terminated before completion.</p>
        <p>I have read and understand the above statements and voluntarily enter into counseling services from the staff of Free for Life Group - BIPP - by entering my name below. (By clicking SUBMIT, I hereby confirm the above information to the best of my knowledge is correct and true, with no misleading or false content in accordance with Texas Perjury Statute, Sec. 37.02 (a) (2) Chapter 32, Civil Practice and Remedies Code.)</p>
      </div>
      <div class="form-check">
  ...
  <fieldset class="step">
    ...
    <div class="mb-3">
      ...
      <input type="text" id="counselor" name="counselor" class="form-control" value="Van Eric Martin">
    </div>
