...
function buildAbsenceRecords()
{
    ...
    $sql = "SELECT id, orientation_date, first_attendance.date first_attendance, weekly_attendance,
            attends_sunday, attends_sunday_t4c, attends_monday, attends_tuesday, attends_wednesday,
