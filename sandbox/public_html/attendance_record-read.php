...
if(isset($_GET["therapy_session_id"]) && !empty($_GET["therapy_session_id"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        $session_id = trim($_GET["therapy_session_id"]);

        mysqli_stmt_bind_param($stmt, "ii", $client_id, $session_id);
...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Attendance Record</title>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            <h4>client_id</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["client_id"]); ?></p>
                        </div><div class="form-group">
                            <h4>therapy_session_id</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["therapy_session_id"]); ?></p>
                        </div><div class="form-group">
                            <h4>note</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["note"]); ?></p>
                        </div>

                    <p><a href="attendance_record-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
