...
define('db_name', 'clinicnotepro_sandbox');
define('db_user', 'clinicnotepro_sandbox_app');
...
foreach ($groupData as $index => $row) {
    $groupData[$index]['link'] = 'group_stub.php';
}
// ----------------------------------------------------
...
<div class="container">
    <a href="https://notesao.com">
        <img alt="NotesAO" src="notesao.png" class="img-fluid mb-3">
    </a>
    ...
    <form method="post">
        ...
        <div class="col">
            ...
            <?php
            // e.g. from 1930..2025; adjust as needed
