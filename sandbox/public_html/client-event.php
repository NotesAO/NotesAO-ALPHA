...
if (isset($_POST['action']) && $_POST['action'] == 'Add New Event') {
    ...
    $stmt = $pdo->prepare("
        INSERT INTO client_event (client_id, client_event_type_id, date, note)
        VALUES (?,?,?,?)
    ");
...
<head>
    <meta charset="UTF-8">
    <title>NotesAO - Client Event</title>
    ...
    <style type="text/css">
        /* Offset the fixed-top navbar height (adjust as needed) */
        body {
            padding-top: 56px; 
            font-size: 16px; 
        }
        /* Adjust spacing for the last-column buttons in the table */
...
<body>
    ...
    <!-- Add "pt-3" so there's padding inside the section -->
    <section class="pt-3">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <h5>
                                <a class="nav-link" href="client-update.php?id=<?php echo htmlspecialchars($client_id); ?>">
                                    Update Client
                                </a>
                            </h5>
                        </div>
            ...
            <div class="row bg-light">
                        ...
                        <div class="col-2">
                            ...
                            <h4>
                                <?php echo htmlspecialchars(
                                    $client["sessions_attended"] . " of " . $client["sessions_required"]
                                ); ?>
                            </h4>
                        </div>
                        <div class="col-2">
                ...
                <div class="col-1 pt-3 pb-3">
                    <div class="row">
                        <img src="getImage.php?id=<?php echo $client_id; ?>"
                             class="img-thumbnail"
                             alt="client picture"
                    ...
                    <div class="row justify-content-center">
                        <a class="nav-link"
                           target="_blank"
                           href="./client-image-upload.php?client_id=<?php echo htmlspecialchars($client_id); ?>">
                           Update Image
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($client_events as $event) {
                                ...
                                echo "<td>";
                                echo "<a href='client-event-update.php?id=" . $event['event_id']
                                     . "&client_id=" . $client_id
                                     . "' title='Update client event record'
                                     data-toggle='tooltip'
                                     class='btn btn-primary'>Update</a>";
                                echo "<a href='client-event-delete.php?id=" . $event['event_id']
                                     . "&client_id=" . $client_id
                                     . "' title='Delete client event record'
                                     data-toggle='tooltip'
                        ...
                        <div class="row">
                            <div class="col-2">
                                ...
                                <select class="form-control"
                                        id="client_event_type_id"
                                        name="client_event_type_id">
                                    <?php
            ...
            <div class="row pt-3 pb-3">
                <div class="col-1">
                    <a href="client-review.php?client_id=<?php echo $client_id; ?>"
                       title="Return to client review"
                       data-toggle="tooltip"
