...
/* -------------------------------------------------
 * 1️⃣  Dynamic config chooser
 * -------------------------------------------------*/
/* 1️⃣  decide which credentials we want */
$useFFL = false;
if (strpos(__DIR__, '/sandbox/') !== false)       $useFFL = true;   // auto
if (!empty($_GET['ffltest']))                     $useFFL = true;   // manual

/* 2️⃣  load that config before anything else */
if ($useFFL) {
    require_once '/home/notesao/ffltest/config/config.php';
} else {
    require_once dirname(__DIR__).'/config/config.php';   // sandbox default
}

/* 3️⃣  NOW you can include files that rely on those constants */
        ...
        <div class="row">
            <div class="col">
                <div class="page-header">
                    <h2>Monthly Activity Report - Free for Life Group</h2>
                </div>
            </div>
        </div>
                ...
                <div class="col-6">
                    ...
                    <table class='table table-bordered table-striped'>
                        ...
                        $sqlAge21 = "
                            ...
                            FROM (
                                SELECT c.id,
                                       DATE_FORMAT(
                                           FROM_DAYS(DATEDIFF(c.orientation_date, c.date_of_birth)),
                                           '%Y'
                                       ) + 0 AS age,
                                       rt.referral_type
                                FROM client c
                            ...
                            WHERE temp.age <= 21
                            GROUP BY temp.referral_type;
                        ";
                        buildMARRow("<= 21", $sqlAge21, $start_date, $end_date);
                        ...
                        ";
                        buildMARRow("22-25", $sqlAge22_25, $start_date, $end_date);
                        ...
                        $sqlAge26_29 = "
                            ...
                            WHERE age >= 26 AND age <= 29
                            GROUP BY referral_type;
                        ";
                        buildMARRow("26-29", $sqlAge26_29, $start_date, $end_date);
                        ...
                        $sqlAge30_39 = "
                            ...
                            GROUP BY referral_type;
                        ";
                        buildMARRow("30-39", $sqlAge30_39, $start_date, $end_date);
                        ...
                        $sqlAge40_49 = "
                            ...
                            GROUP BY referral_type;
                        ";
                        buildMARRow("40-49", $sqlAge40_49, $start_date, $end_date);
                        ...
                        $sqlAge50 = "
                            ...
                            GROUP BY referral_type;
                        ";
                        buildMARRow("50 +", $sqlAge50, $start_date, $end_date);
                    ...
                    <table class='table table-bordered table-striped'>
                        ...
                        $sqlAA = "
                            ...
                            FROM client c
                            LEFT JOIN referral_type rt ON c.referral_type_id = rt.id
                            LEFT JOIN ethnicity e ON c.ethnicity_id = e.id
                            WHERE c.program_id = $program_id
                              AND (orientation_date BETWEEN ? AND ?)
                              AND e.code = 'B'
                            GROUP BY rt.referral_type;
                        ";
                        buildMARRow("African American", $sqlAA, $start_date, $end_date);
                        ...
                        $sqlCauc = "
                            ...
                            GROUP BY rt.referral_type;
                        ";
                        buildMARRow("Caucasian", $sqlCauc, $start_date, $end_date);
                        ...
                        $sqlHisp = "
                            ...
                            GROUP BY rt.referral_type;
                        ";
                        buildMARRow("Hispanic", $sqlHisp, $start_date, $end_date);
                        ...
                        $sqlOther = "
                            ...
                            WHERE c.program_id = $program_id
                              AND (orientation_date BETWEEN ? AND ?)
                              AND e.code NOT IN ('B','W','H')
                            GROUP BY rt.referral_type;
                        ";
                        buildMARRow("Other", $sqlOther, $start_date, $end_date);
